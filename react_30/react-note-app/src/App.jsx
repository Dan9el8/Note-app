...
const App = () => {
  ...
  const filteredNotes =
    filterText === "BUSINESS"
      ...
      useEffect(() => {
        ...
        axios.get(`http://127.0.0.1:8002/notes-search/?search=${searchText}`)
        .then(res => {
  ...
  const addNote = (data) => {
    axios
      .post("http://127.0.0.1:8002/notes/", data)
      .then((res) => {
        setNotes([...notes, data]);
  ...
  const updateNote = (data, slug) => {
    axios
      .put(`http://127.0.0.1:8002/notes/${slug}/`, data)
      .then((res) => {
        console.log(res.data);
  ...
  const deleteNote = (slug) => {
    axios
      .delete(`http://127.0.0.1:8002/notes/${slug}`)
      .catch((err) => console.log(err.message));
  };
